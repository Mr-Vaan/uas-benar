...
?>
<div class="modal fade" id="keranjangModal" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel"
    aria-hidden="true">
        ...
        <div class="modal-content">
            <form method="post">
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <span style="padding: 10px;"
                                                class="badge badge-pill badge-dark"><?=$status_d?></span>
                                            <?php
											} elseif ($status_d == "dimasak") {
											?>
                                            <span style="padding: 10px;"
                                                class="badge badge-pill badge-info"><?=$status_d?></span>
                                            <?php
											} elseif ($status_d == "siap") {
											?>
                                            <span style="padding: 10px;"
                                                class="badge badge-pill badge-success"><?=$status_d?></span>
                                            <?php
											} elseif ($status_d == "diambil") {
											?>
                                            <span style="padding: 10px;"
                                                class="badge badge-pill badge-danger"><?=$status_d?></span>
                                            <?php
											}
											?>
                                        </td>
                                        <td>
                                            <button id="bthapus2<?=$no;?>" class="btn btn-danger btn-sm">Batal
                                                Beli</button>
                                        </td>
                                    </tr>
                                        ...
                                        swal({
                                            ...
                                            if (isConfirm) {
                                                window.location.href =
                                                    "?page=detail_menu&hapus2&kd=<?=$datas['kd_detail'];?>";
                                            }
                                        })
                                    })
                                    </script>
                        ...
                        <div class="form-group">
                            ...
                            <h6 style="color: red;">Cat : Pastikan nama menu tercantum ketika ingin menambah catatan
                            </h6>
                            <br>
                            <?php
							@$dk = $dkt;
                            ...
                            <textarea class="form-control" name="keterangan" rows="3"
                                placeholder="Contoh : Untuk gado gado ga pake mentimun, ayam serundeng banyakin bumbunya"><?=$dk['keterangan']?></textarea>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
					...
					if ($st == "S") {
					?>
                    <span style="padding: 10px;" class="badge badge-pill badge-success"><i class="fa fa-check"></i>
                        Catatan anda telah dikonfirmasi</span>
                    <?php
					} elseif ($st == "T") {
					?>
                    <span style="padding: 10px;" class="badge badge-pill badge-danger">Catatan anda tidak dikonfirmasi
                        dikarenakan <span>Bumbu telah habis</span></span>
                    <?php
					}
					?>
            ...
            <div class="col-md-12">
                <div class="au-breadcrumb-content">
                    <div class="au-breadcrumb-left">
                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                            ...
                            <li class="list-inline-item">
                                <a
                                    href="?page=order_menu&kategori&menu&kd=<?=$getKategori['kd_kategori']?>"><?=$getKategori['name_kategori']?></a>
                            </li>
                            <li class="list-inline-item"><span><i class="zmdi zmdi-chevron-right"></i></span></li>
                    ...
                    <div class="au-breadcrumb-right">
                        <button data-toggle="modal" data-target="#keranjangModal"
                            class="btn btn-lg btn-success btn-fab">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-counter input-group" style="display: none;">
                                                    ...
                                                    <input type="number" name="total" class="form-control counter"
                                                        data-min="1" id="
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" id="hargas" type="number" name="harga"
                                                        value="<?=$getMenu['harga']?>">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <br>
                                                <button name="btnTambah" class="btn btn-success float-right">Tambahkan
                                                    ke keranjang</button>
                                                <br>
                                                <br>
                                            </div>
