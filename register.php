...
<body class="animsition"
    style="background: linear-gradient( rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5) ), url('images/bg3.jpg') no-repeat; background-size: cover;">
            ...
            <div class="login-wrap">
                <div class="login-content">
                    <div class="login-logo">
                        <a href="#">
                            <img src="images/icon/logo-DT.png" alt="KukerId" width="70"> <b>K</b>uker
                            <b>ID</b>
                        </a>
                    </div>
                    <div class="login-form">
                        <form action="" method="post">
                            ...
                            <div class="form-group">
                                <label>Nama</label>
                                <input class="au-input au-input--full" type="text" name="nama_user"
                                    value="<?php echo @$_POST['nama_user'] ?>" placeholder="Nama">
                            </div>
                            <div class="form-group">
                                <label>Email</label>
                            ...
                            <div class="form-group">
                                ...
                                <input class="au-input au-input--full" type="password" name="confirm"
                                    placeholder="Confirm Password" value="<?php echo @$_POST['confirm'] ?>">
                            </div>
                            <div class="form-group">
                            ...
                            <br>
                            <button name="btnRegister" class="au-btn au-btn--block au-btn--green m-b-20"
