                    ...
                    <div class="login-form">
                        <form action="" method="post">
                            <div class="form-group">
                                ...
                                <input autocomplete="off" value="<?=@$_POST['username']?>"
                                    class="au-input au-input--full" type="text" name="username"
                                    placeholder="Nama Lengkap Anda"">
                                </div>
                                <div class=" form-group">
                                <label>Password</label>
                                <input class="au-input au-input--full" type="number" name="password"
                                    placeholder="Gunakan nomor meja sebagai password anda untuk login">
                            </div>
                            ...
                            <br>
                            <button name="btnLogin" class="au-btn au-btn--block au-btn--green m-b-20" type="submit">sign
                                in</button>
                        </form>
                    </div>
                </div>
